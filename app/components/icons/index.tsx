...
export const UserCheckIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.667}
      d="M10 12.917H6.25c-1.163 0-1.745 0-2.218.143a3.333 3.333 0 0 0-2.222 2.222c-.143.473-.143 1.055-.143 2.218M13.332 15 15 16.667l3.333-3.334m-6.25-7.083a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z"
    />
  </svg>
);
